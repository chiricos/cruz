...
<?php endif; ?>
		...
		<form method="post" class="login">
			...
			<p class="form-row form-row-wide">
				<label for="username"><?php esc_html_e( 'Usuario o dirección de correo', 'woocommerce' ); ?> <span class="required">*</span></label>
			...
			<p class="form-row">
				<label for="rememberme" class="inline">
					<input name="rememberme" type="checkbox" id="rememberme" value="forever" /> <?php esc_html_e( 'Recordarme', 'woocommerce' ); ?>
				</label>
			</p>
			<p class="form-row">
				<?php wp_nonce_field( 'woocommerce-login' ); ?>
				<input type="submit" class="button" name="login" value="<?php esc_html_e( 'Iniciar sesión', 'woocommerce' ); ?>" /> 
			</p>
			<p class="lost_password">
				<a href="<?php echo esc_url( wc_lostpassword_url() ); ?>"><?php esc_html_e( 'Perdio su contraseña', 'woocommerce' ); ?></a>
			</p>
...
<?php if ( get_option( 'woocommerce_enable_myaccount_registration' ) === 'yes' ) : ?>
	...
	<div class="col-lg-6 col-md-6 col-sm-12">
		...
		<h2><?php esc_html_e( 'Registar', 'woocommerce' ); ?></h2>
		...
		<form method="post" class="register">
			...
			<p class="form-row form-row-wide">
				<label for="reg_email"><?php esc_html_e( 'Dirección de correo', 'woocommerce' ); ?> <span class="required">*</span></label>
