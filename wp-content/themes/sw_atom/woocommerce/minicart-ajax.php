...
<div class="top-form top-form-minicart ya-minicart pull-right">
	<div class="top-minicart-icon pull-right">
		<span class="shopping-text"><?php esc_html_e('Carrito de compras','yatheme');?></span>
	...
	<div class="detail-item">
		<div class="product-details"> 
			...
			<div class="product-action">
				...
				<a class="btn-edit" href="<?php echo $woocommerce->cart->get_cart_url(); ?>" title="<?php esc_html_e('Ver carrito de compras', 'yatheme'); ?>"><span></span></a>    
			</div>
		</div>	
	</div>
