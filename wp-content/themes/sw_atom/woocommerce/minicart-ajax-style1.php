...
<div class="top-form top-form-minicart ya-minicart-style1 pull-right">
	<div class="top-minicart-icon pull-right">
		<i class="fa fa-shopping-cart"></i><a class="cart-contents" href="<?php echo $woocommerce->cart->get_cart_url(); ?>" title="<?php esc_html_e('Ver compras', 'yatheme'); ?>"><?php echo '<span class="minicart-number">'.$woocommerce->cart->cart_contents_count.'</span>';  esc_html_e('item(s)', 'yatheme');?> :  <?php echo $woocommerce->cart->get_cart_total(); ?></a>
	</div>
	<div class="wrapp-minicart">
		<div class="minicart-padding">
			<h2><?php echo esc_html_e('Productos recientes', 'yatheme');?></h2>
...
?>
			...
			<div class="cart-checkout">
				...
				<div class="cart-links">
					<div class="cart-link"><a href="<?php echo get_permalink(get_option('woocommerce_cart_page_id')); ?>" title="Cart"><?php esc_html_e('Ver carrito', 'yatheme'); ?></a></div>
					<div class="checkout-link"><a href="<?php echo get_permalink(get_option('woocommerce_checkout_page_id')); ?>" title="Check Out"><?php esc_html_e('Detalles', 'yatheme'); ?></a></div>
				</div>
			</div>
		</div>
	</div>
