...
function ya_woocommerce_catalog_ordering() {
	...
	$html .= '<span class="sort">Ordenar por</span>';
	...
	$html .= '<ul>';
	$html .= '<li class="'.(($pob == 'default') ? 'current': '').'"><a href="'.ya_addURLParameter($query_string, 'product_orderby', 'default').'">'.__('', 'yatheme').__('Defecto', 'yatheme').'</a></li>';
	$html .= '<li class="'.(($pob == 'name') ? 'current': '').'"><a href="'.ya_addURLParameter($query_string, 'product_orderby', 'name').'">'.__('', 'yatheme').__('Nombre', 'yatheme').'</a></li>';
	$html .= '<li class="'.(($pob == 'price') ? 'current': '').'"><a href="'.ya_addURLParameter($query_string, 'product_orderby', 'price').'">'.__('', 'yatheme').__('Precio', 'yatheme').'</a></li>';
	$html .= '<li class="'.(($pob == 'date') ? 'current': '').'"><a href="'.ya_addURLParameter($query_string, 'product_orderby', 'date').'">'.__('', 'yatheme').__('Fecha', 'yatheme').'</a></li>';
	$html .= '<li class="'.(($pob == 'rating') ? 'current': '').'"><a href="'.ya_addURLParameter($query_string, 'product_orderby', 'rating').'">'.__('', 'yatheme').__('Clasificación', 'yatheme').'</a></li>';
	$html .= '</ul>';
	$html .= '</li>';
	$html .= '</ul>';
	$html .= '<span class="show-product"> Mostrar </span>';
	...
	$html .= '</li>';
	$html .= '</ul>';
	$html .= '<span class="per-page"> Por página </span>';
	$html .= '</div>';
	$html .= '</div>';
...
function ya_product_excerpt(){
	...
	$html .= '<h2 class="quick-overview">'. __( 'Descripción', 'yatheme' ) .'</h2>';
