...
function Ya_Options_Setup(){
	...
	$options[] = array(
			...
			'desc' => __('<p class="description">The theme allows to build your own styles right out of the backend without any coding knowledge. Start your own color scheme by selecting one of 6 predefined schemes. Upload new logo and favicon or get their URL.</p>', 'yatheme'),
			//all the glyphicons are included in the options folder, so you can hook into them, or link to your own custom ones.
			//You dont have to though, leave it blank for default.
