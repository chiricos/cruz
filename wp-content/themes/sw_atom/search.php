...
<div class="category-header">
	<div class="container">
		<h1 class="entry-title"><?php esc_html_e( 'Buscar', 'yatheme' ); ?></h1>		
		<div class="bread">
		<?php
			...
			<div id="post-<?php the_ID();?>" <?php post_class( 'theme-clearfix' ); ?>>
				<div class="entry clearfix">
					...
					<div class="entry-content">
						...
						<div class="bl_read_more"><a href="<?php the_permalink(); ?>"><?php esc_html_e('Lee más','yatheme')?><i class="fa fa-angle-double-right"></i></a></div>
