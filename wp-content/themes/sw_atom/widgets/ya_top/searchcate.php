	...
	<?php if ( in_array( 'woocommerce/woocommerce.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) { ?>
		<form method="get" id="searchform_special" action="<?php echo esc_url( home_url( '/'  ) ); ?>">
			<div>
				...
				<div class="cat-wrapper">
					<label class="label-search">
						<select name="search_category" class="s1_option">
							<option value=""><?php esc_html_e( 'Todas las categorías', 'yatheme' ) ?></option>
				...
				<?php } ?>
				<input type="text" value="<?php echo get_search_query(); ?>" name="s" id="s" placeholder="<?php esc_html_e( 'Buscar productos', 'woocommerce' ); ?>" />
...
<div class="popular-search-keyword">
	<div class="keyword-title"><?php esc_html_e( 'Buscar', 'yatheme' ) ?>: </div>
	<?php 
